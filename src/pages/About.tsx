...
const About: React.FC = () => (
  <div className="pt-24 max-w-4xl mx-auto px-4 space-y-8">
    ...
    <p className="text-gray-700 text-lg">
      From custom software development and system architecture to deployment and quality assurance,
      we cover the full software development lifecycle with precision and care.
    </p>
    <p className="text-gray-700 text-lg">
      We believe in transparent communication, agile methodologies, and delivering solutions that
